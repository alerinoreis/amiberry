 ...
 */
static ALWAYS_INLINE bool mmu_lookup(uaecptr addr,
	bool data,
	bool write,
...
/*
 */
static ALWAYS_INLINE bool mmu_user_lookup(uaecptr addr,
	bool super,
	bool data,
	bool write,
	struct mmu_atc_line **cl)
...
extern uae_u8 REGPARAM3 mmu_get_byte_slow(uaecptr addr,
	bool super,
	bool data,
	int size,
	bool rmw,
	struct mmu_atc_line *cl) REGPARAM;
extern uae_u16 REGPARAM3 mmu_get_word_slow(uaecptr addr,
	bool super,
	bool data,
	int size,
	bool rmw,
	struct mmu_atc_line *cl) REGPARAM;
extern uae_u32 REGPARAM3 mmu_get_long_slow(uaecptr addr,
	bool super,
	bool data,
	int size,
	bool rmw,
...
extern uae_u16 REGPARAM3 mmu_get_iword_slow(uaecptr addr,
	bool super,
	int size,
	struct mmu_atc_line *cl) REGPARAM;
extern uae_u32 REGPARAM3 mmu_get_ilong_slow(uaecptr addr,
	bool super,
	int size,
	struct mmu_atc_line *cl) REGPARAM;
...
extern void REGPARAM3 mmu_put_byte_slow(uaecptr addr,
	uae_u8 val,
	bool super,
	bool data,
	int size,
	bool rmw,
	struct mmu_atc_line *cl) REGPARAM;
extern void REGPARAM3 mmu_put_word_slow(uaecptr addr,
	uae_u16 val,
	bool super,
	bool data,
	int size,
	bool rmw,
	struct mmu_atc_line *cl) REGPARAM;
extern void REGPARAM3 mmu_put_long_slow(uaecptr addr,
	uae_u32 val,
	bool super,
	bool data,
	int size,
