...
STATIC_INLINE uae_u32 next_iword_mmu030_state()
{
	uae_u32 v;
...
STATIC_INLINE uae_u32 next_ilong_mmu030_state()
{
	uae_u32 v;
	uae_u32 addr = m68k_getpci();
...
STATIC_INLINE uae_u32 next_iword_mmu030()
{
	uae_u32 v;
...
STATIC_INLINE uae_u32 next_ilong_mmu030()
{
	uae_u32 v;
	uae_u32 pc = m68k_getpci();
...
extern void m68k_do_rts_mmu030();
