...
extern void memory_restore();
extern void a1000_reset();
...
extern void expansion_cpu_fallback();
...
extern void set_roms_modified();
extern void reload_roms();
...
{
	do_put_mem_long(static_cast<uae_u32*>(addr), v >> 32);
	do_put_mem_long(static_cast<uae_u32*>(addr) + 1, uae_u32(v));
}

STATIC_INLINE void put_long_host(void* addr, uae_u32 v)
{
	do_put_mem_long(static_cast<uae_u32*>(addr), v);
}

STATIC_INLINE void put_word_host(void* addr, uae_u16 v)
{
	do_put_mem_word(static_cast<uae_u16*>(addr), v);
}

STATIC_INLINE void put_byte_host(void* addr, uae_u8 v)
{
	*static_cast<uae_u8*>(addr) = v;
}

STATIC_INLINE uae_u64 get_quad_host(void* addr)
{
	uae_u64 v = static_cast<uae_u64>(do_get_mem_long(static_cast<uae_u32*>(addr))) << 32;
	v |= do_get_mem_long(static_cast<uae_u32*>(addr) + 1);
	return v;
}

STATIC_INLINE uae_u32 get_long_host(void* addr)
{
	return do_get_mem_long(static_cast<uae_u32*>(addr));
}

STATIC_INLINE uae_u16 get_word_host(void* addr)
{
	return do_get_mem_word(static_cast<uae_u16*>(addr));
}

STATIC_INLINE uae_u32 get_byte_host(void* addr)
{
	return *static_cast<uae_u8*>(addr);
}
