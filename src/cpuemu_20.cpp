...
{	uae_s32 dst = m68k_dreg (regs, dstreg);
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_200844;
	regs.irc = get_word_020_prefetch (0);
}}}l_200844: ;
return 8 * CYCLE_UNIT / 2;
}
...
{	uae_s32 dst = x_get_long (dsta);
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_200845;
	regs.irc = get_word_020_prefetch (0);
}}}}l_200845: ;
return 16 * CYCLE_UNIT / 2;
}
...
{	uae_s32 dst = x_get_long (dsta);
	m68k_areg (regs, dstreg) += 4;
	m68k_incpci (4);
	if (!m68k_mull(opcode, dst, extra)) goto l_200846;
	regs.irc = get_word_020_prefetch (0);
}}}}l_200846: ;
return 16 * CYCLE_UNIT / 2;
}
...
{	uae_s32 dst = m68k_dreg (regs, dstreg);
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_200855;
	regs.irc = get_word_020_prefetch (0);
}}}l_200855: ;
return 8 * CYCLE_UNIT / 2;
}
...
{	uae_s32 dst = x_get_long (dsta);
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_200856;
	regs.irc = get_word_020_prefetch (0);
}}}}l_200856: ;
return 16 * CYCLE_UNIT / 2;
}
...
{	uae_s32 dst = x_get_long (dsta);
	m68k_areg (regs, dstreg) += 4;
	m68k_incpci (4);
	if (!m68k_divl(opcode, dst, extra)) goto l_200857;
	regs.irc = get_word_020_prefetch (0);
}}}}l_200857: ;
return 16 * CYCLE_UNIT / 2;
}
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_200885; }
{{	uae_s32 src = m68k_areg (regs, srcreg);
	regs.usp = src;
	regs.irc = get_word_020_prefetch (2);
}}}	m68k_incpci (2);
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_200886; }
{{	regs.irc = get_word_020_prefetch (2);
...
{
{if (!regs.s) { Exception (8); goto l_200887; }
{	cpureset ();
	m68k_incpci (2);
	regs.irc = get_word_020_prefetch (0);
}}l_200887: ;
...
{	uae_u16 newsr; uae_u32 newpc;
	for (;;) {
		...
		else { m68k_areg (regs, 7) += offset; Exception (14); goto l_200890; }
		regs.sr = newsr;
	MakeFromSR();
}
	regs.sr = newsr;
...
{
{if (!regs.s) { Exception (8); goto l_200895; }
{{	uae_s16 src = get_word_020_prefetch (2);
{	int regno = (src >> 12) & 15;
	uae_u32 *regp = regs.regs + regno;
	if (! m68k_movec2(src & 0xFFF, regp)) goto l_200895;
	regs.irc = get_word_020_prefetch (4);
}}}}	m68k_incpci (4);
l_200895: ;
return 8 * CYCLE_UNIT / 2;
...
{
{if (!regs.s) { Exception (8); goto l_200896; }
{{	uae_s16 src = get_word_020_prefetch (2);
{	int regno = (src >> 12) & 15;
	uae_u32 *regp = regs.regs + regno;
	if (! m68k_move2c(src & 0xFFF, regp)) goto l_200896;
	regs.irc = get_word_020_prefetch (4);
}}}}	m68k_incpci (4);
l_200896: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 0)) { Exception (7); goto l_200946; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_200946: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	...
	if (cctrue (regs.ccrflags, 0)) { Exception (7); goto l_200947; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_200947: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 0)) { Exception (7); goto l_200948; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_200948: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 1)) { Exception (7); goto l_200984; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_200984: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 1)) { Exception (7); goto l_200985; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_200985: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 1)) { Exception (7); goto l_200986; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_200986: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 2)) { Exception (7); goto l_200996; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_200996: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 2)) { Exception (7); goto l_200997; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_200997: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 2)) { Exception (7); goto l_200998; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_200998: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 3)) { Exception (7); goto l_201008; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201008: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 3)) { Exception (7); goto l_201009; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201009: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 3)) { Exception (7); goto l_201010; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201010: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 4)) { Exception (7); goto l_201020; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201020: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 4)) { Exception (7); goto l_201021; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201021: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 4)) { Exception (7); goto l_201022; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201022: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 5)) { Exception (7); goto l_201032; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201032: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 5)) { Exception (7); goto l_201033; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201033: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 5)) { Exception (7); goto l_201034; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201034: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 6)) { Exception (7); goto l_201044; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201044: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 6)) { Exception (7); goto l_201045; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201045: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 6)) { Exception (7); goto l_201046; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201046: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 7)) { Exception (7); goto l_201056; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201056: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 7)) { Exception (7); goto l_201057; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201057: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 7)) { Exception (7); goto l_201058; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201058: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 8)) { Exception (7); goto l_201068; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201068: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 8)) { Exception (7); goto l_201069; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201069: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 8)) { Exception (7); goto l_201070; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201070: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 9)) { Exception (7); goto l_201080; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201080: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 9)) { Exception (7); goto l_201081; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201081: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 9)) { Exception (7); goto l_201082; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201082: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 10)) { Exception (7); goto l_201092; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201092: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 10)) { Exception (7); goto l_201093; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201093: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 10)) { Exception (7); goto l_201094; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201094: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 11)) { Exception (7); goto l_201104; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201104: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 11)) { Exception (7); goto l_201105; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201105: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 11)) { Exception (7); goto l_201106; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201106: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 12)) { Exception (7); goto l_201116; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201116: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 12)) { Exception (7); goto l_201117; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201117: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 12)) { Exception (7); goto l_201118; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201118: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 13)) { Exception (7); goto l_201128; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201128: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 13)) { Exception (7); goto l_201129; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201129: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 13)) { Exception (7); goto l_201130; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201130: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 14)) { Exception (7); goto l_201140; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201140: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 14)) { Exception (7); goto l_201141; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201141: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 14)) { Exception (7); goto l_201142; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201142: ;
return 4 * CYCLE_UNIT / 2;
...
{
{{	uae_s16 dummy = get_word_020_prefetch (2);
	if (cctrue (regs.ccrflags, 15)) { Exception (7); goto l_201152; }
	regs.irc = get_word_020_prefetch (4);
}}	m68k_incpci (4);
l_201152: ;
return 8 * CYCLE_UNIT / 2;
...
{{	uae_s32 dummy;
	dummy = get_long_020_prefetch (2);
	if (cctrue (regs.ccrflags, 15)) { Exception (7); goto l_201153; }
	regs.irc = get_word_020_prefetch (6);
}}	m68k_incpci (6);
l_201153: ;
return 12 * CYCLE_UNIT / 2;
...
{
{	if (cctrue (regs.ccrflags, 15)) { Exception (7); goto l_201154; }
	regs.irc = get_word_020_prefetch (2);
}	m68k_incpci (2);
l_201154: ;
return 4 * CYCLE_UNIT / 2;
...
{	uae_s16 extra = get_word_020_prefetch (2);
	...
	if (regs.fp_exception) goto l_201785;
	regs.irc = get_word_020_prefetch (0);
}
#endif
}l_201785: ;
...
{	uae_s16 extra = get_word_020_prefetch (2);
	m68k_incpci (4);
	fpuop_arithmetic(opcode, extra);
	if (regs.fp_exception) goto l_201786;
	regs.irc = get_word_020_prefetch (0);
}
#endif
}l_201786: ;
...
{	uae_s16 extra = get_word_020_prefetch (2);
	m68k_incpci (4);
	fpuop_arithmetic(opcode, extra);
	if (regs.fp_exception) goto l_201787;
	regs.irc = get_word_020_prefetch (0);
}
#endif
}l_201787: ;
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_201811; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_201812; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
...
{
	uae_u32 srcreg = (opcode & 7);
{if (!regs.s) { Exception (8); goto l_201813; }
{
#ifdef FPUEMU
	m68k_incpci (2);
	fpuop_save (opcode);
